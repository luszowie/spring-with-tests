...
public class SpringMvcTest {
    ...
    @Test
    public void testSchoppingBasketExistProductExistSchoppingBasketItemExist() throws Exception {
        ShoppingBasket shoppingBasket = new ShoppingBasket();
        shoppingBasket = shoppingBasketDao.save(shoppingBasket);
    ...
    @Test
    public void testSchoppingBasketExistProductExistSchoppingBasketItemNotExist() throws Exception {
        ShoppingBasket shoppingBasket = new ShoppingBasket();
        shoppingBasket = shoppingBasketDao.save(shoppingBasket);
